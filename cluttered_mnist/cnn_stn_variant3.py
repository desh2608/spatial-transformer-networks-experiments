...
W_fc_loc0 = weight_variable([1600,32])
b_fc_loc0 = bias_variable([32])

h_fc_loc0 = tf.nn.tanh(tf.matmul(x,W_fc_loc0) + b_fc_loc0)

W_fc_loc1 = weight_variable([32, 64])
...
h_fc_loc1 = tf.nn.tanh(tf.matmul(h_fc_loc0, W_fc_loc1) + b_fc_loc1)
...
f = open("./results/cnn_stn_variant3.dat","w")
